...
//   // Effect to handle profile update success/error
//   useEffect(() => {
//     if (updateSuccess) {
//       refetch()
//         .then(() => {
...
//           toast.error("Profile updated but couldn't refresh data");
//         });
//     }
...
//         <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-blue-500 dark:border-blue-400"></div>
//       </div>
//     );
//   }
...
//   if (error || !data?.user) {
//     return (
//       <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex justify-center items-center text-red-600 dark:text-red-400 text-xl">
